...
let paperclip;
let userInputHeight;
let hide_systemPrompt;
let slide_systemPrompt_icon;

document.addEventListener("DOMContentLoaded", (event) => {
    chatBody          = document.getElementById(`chatBody`);
    userInput         = document.getElementById("userInput");
    codeButton        = document.querySelector(".code");
    box_conversations = document.querySelector(`#box_conversations, .top`);
    stop_generating   = document.querySelector(`.stop_generating`);
    regenerate_button = document.querySelector(`.regenerate`);
    sidebar           = document.querySelector(".sidebar");
    sidebar_buttons   = document.querySelectorAll(".mobile-sidebar-toggle");
    sendButton        = document.getElementById("sendButton");
    addButton         = document.getElementById("addButton");
    imageInput        = document.querySelector(".image-label");
    ...
    audioButton       = document.querySelector(".capture-audio");
    linkButton        = document.querySelector(".add-link");
    fileInput         = document.getElementById("file");
    microLabel        = document.querySelector(".micro-label");
    inputCount        = document.getElementById("input-count").querySelector(".text");
    ...
    settingsContent   = settings.querySelector(".settings-content") || settings.querySelector(".paper");
    chat              = document.querySelector(".chat-container");
    album             = document.querySelector(".images");
    searchButton      = document.getElementById("search");
    paperclip         = document.querySelector(".user-input .fa-paperclip");
    userInputHeight   = document.getElementById("userInput-height");
    hide_systemPrompt = document.getElementById("hide-systemPrompt")
    slide_systemPrompt_icon = document.querySelector(".slide-header i");
});
