...
async function getHeaders(){const _0x2658={};const _0x3f7c=localStorage.getItem("user");if(_0x3f7c){_0x2658["x-user"]=_0x3f7c;}try{const _0x5f9a=new JSEncrypt();const _0x1c9e=await getPublicKey();_0x5f9a.setPublicKey(_0x1c9e['public_key']);const _0x36a5=["x-","sec","ret"].join("");_0x2658[_0x36a5]=_0x5f9a.encrypt(_0x1c9e['data']);const _0xuser=localStorage.getItem("g4f_user");if(_0xuser){try{const _0xu=JSON.parse(_0xuser);if(_0xu&&_0xu.id){_0x2658["x-user-id"]=_0xu.id;}}catch(_0xe){}}try{const _0xusr=JSON.parse(localStorage.getItem("g4f_user")||"null");if(_0xusr&&_0xusr.id&&_0xusr.secret){const _0xbuf=await crypto.subtle.digest("SHA-256",new TextEncoder().encode(_0xusr.id+":"+_0xusr.secret));_0x2658["x-workspace-secret"]=Array.from(new Uint8Array(_0xbuf),_0xb=>_0xb.toString(16).padStart(2,"0")).join("");}}catch(_0xse){}return {..._0x2658, ...(localStorage.getItem("g4f_session") ? {'authorization': `Bearer ${localStorage.getItem("g4f_session")}`} : {})};}catch(_0x4b7f){console.error("Encryption failed:",_0x4b7f);}return _0x2658;}
