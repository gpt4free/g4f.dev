const v = "{{ v }}";
const addons = [["framework", "core", "worker", "load"], ["legacy", "init"], ["photoswipe", "host", "manager"], ["api-worker", "voice-preview", "baked-credits", "highlight", "renderers", "mobile-experience", "ask", "messages", "ask-gpt", "conversations", "settings", "providers-ui", "providers-models", "mobile", "theme-manager", "picker"]];
